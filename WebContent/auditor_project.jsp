...
$(document).ready(function (){
	$('body').on('click','#addBudget',function(event){
		layer_show('添加预算','budget_add.jsp?projectId='+this.title,'800','500');
	}); 
	...
	$.ajax({    
        ...
        success: function(data) { 
    		...
    		for(var i = 0; i < data.length; i++){
				...
				"<a style='text-decoration:none' id = 'addBudget' href='javascript:;' title='"+data[i].projectId+"'>"+
