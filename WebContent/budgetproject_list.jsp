...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="javascript:;" onclick="budget_add('添加预算项目','budget_add.jsp','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加项目预算</a></span>   </div>
...
$(document).ready(function (){
	$('body').on('click','#select',function(event){
		layer_show('项目编辑','budget_add.jsp?projectId='+this.title,'800','500');
	});  
	...
	$.ajax({    
        type: "post",    
        async: true,    
        url: "/repay/searchBudgetProject.do",  
        dataType: "json", 
        ...
        success: function(data) { 
    		...
    		for(var i = 0; i < data.length; i++){
				...
				"<td class='td-manage'>"+
				"<a style='text-decoration:none' id = 'select' href='javascript:;' title='"+data[i].projectId+"'>"+
