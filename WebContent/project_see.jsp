...
<article class="page-container" id = 'form-item-add'>
	...
	<div class="row cl">
		...
		<tbody id = 'tbody-project'>
			...
			<tr>
				<th width = '20%'>开始日期</th>
				<td width = '20%' ><input type="text" class="input-text" value="" placeholder="" id="startDate" name="startDate"></td>
				<td width = '20%' >完成日期</td>
				<td width = '40%' colspan='2'><input type="text" class="input-text" value="" placeholder="" id="endDate" name="endDate"></td>
			</tr>
		</tbody>
	</table>
	</div>
