	...
	$.ajax({    
        ...
        success: function(data) { 
    		...
    		for(var i = 0; i < data.length; i++){
				...
				"<a style='text-decoration:none' id = 'addRepay' href='javascript:;' title='projectId="+data[i].projectId+"&projectName="+data[i].projectName+"'>"+
					"<i class='Hui-iconfont'>&#xe604;</i>"+
				"</a>"+
				"</td>";
				str+="<td class='td-manage'>"+
				"<a style='text-decoration:none' id = 'addSummary' href='javascript:;' title='projectId="+data[i].projectId+"&projectName="+data[i].projectName+"'>"+
					"<i class='Hui-iconfont'>&#xe604;</i>"+
				"</a>"+
				"</td>";
				str+="<td class='td-manage'>"+
