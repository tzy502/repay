...
public interface ITravelService {
	public void addTravel( int repayId, String travelLocation, String travelProvince,
			...
			float stayFees, float foodFees, float miFess, float other )throws BaseException; 
	public void modifryTravel( int travelId, int repayId, String travelLocation, String travelProvince,
			Date  startData, Date endData, int days, float plane, float train, float tasfficOther,
			float stayFees, float foodFees, float miFess, float other)throws BaseException;
